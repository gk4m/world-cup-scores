<template>
  <div class="stats-view">
    <tabs v-if="playersGoalScored" :options="{ useUrlFragment: false }">
          ...
          <template slot="items" slot-scope="props">
            ...
            <td class="table__player">
              <div class="table__player__img">
                ...
                <img
                  class="table__player__flag"
                  :src="
                    require(`@/assets/img/flags/${props.item.countrycode.toLowerCase()}.png`)
                  "
                  alt=""
                />
              </div>
    ...
    <loading-spinner v-if="!playersGoalScored" />
  </div>
</template>
