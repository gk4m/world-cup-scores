<template>
  <div :class="elClasses">
    ...
    <div class="match-item__penalties" v-if="match.home_team.penalties && match.away_team.penalties">
      {{match.winner}} win on penalties ({{match.home_team.penalties}}-{{match.away_team.penalties}})
    </div>
  </div>
</template>
